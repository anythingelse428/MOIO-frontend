...
const groupsFetch = useLazyAsyncData('allGroups', () => groupStore.getAll(), { deep: false })
const groupFetch = useLazyAsyncData(`groupById-${home.value}`, () => groupStore.getGroupById(home.value), { deep: false })
